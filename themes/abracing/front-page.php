<?php get_header(); ?>
    ...
    <div class="ab-pkg-section" id="ab-pkg-section">
        <div class="container">
          <div class="row">
            ...
            <div class="our-location-con-cntlr">
              <div class="our-location-sec-title-cntlr">
                <div class="sec-entry-hdr">
                  <h2 class="fl-h3 sec-entry-hdr-title">Our Location</h2>
                </div>
              </div>
                ...
                <div class="our-location-lft">
                  <div class="our-location-info-cntlr">
                    <div class="our-location-info-title-cntlr">
                      <h3 class="fl-h5 our-location-info-title">we are a  friendly team! <br>come visit us today!</h3>
                    </div>
                    <div class="our-location-form-dtails">
                      <div class="hm-cntct-addres">
                        <a href="#" target="_blank">Jumeirah Fish Market, Jumeirah 1 <br>Jumeirah - Dubai</a>
                      </div>
                      <div class="hm-cntct-tel">
                        <span>Phone: </span>
                        <a href="tel:+971567372727">+971 56 7372727</a>
                      </div>
                      <div class="hm-cntct-tel">
                        <span>Book via WhatsApp: </span>
                        <a href="tel:+61882666650">+971567372727</a>
                      </div>
                    </div>
                  </div>
                </div>
